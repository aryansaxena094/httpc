...
class HttpResponse {
    ...
    public void printResponseToFile(HttpRequest request) {
        ...
        try {
            Files.write(Paths.get(request.getOutputFile()), sb.toString().getBytes());
            System.out.println("Response written to file " + request.getOutputFile());
        } catch (Exception e) {
            System.out.println("Error writing to file " + request.getOutputFile());
            e.printStackTrace();
        }
    }
